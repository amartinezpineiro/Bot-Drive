    ...
    public static void main(String... args) throws IOException, GeneralSecurityException {
        ...
        if (files == null || files.isEmpty()) {
            ...
            FileList resultImagenes = service.files().list()
                    .setQ("name contains 'bot_bbyoda' and parents in '"+dirImagenes+"'")
                    .setSpaces("drive")
                    .setFields("nextPageToken, files(id, name)")
                    .execute();
            ...
            for (File file : filesImagenes) {
                ...
                OutputStream outputStream = new FileOutputStream("/home/dam1/git/ExamenCod/src/main/resources/aux.jpeg");
